...
public class RecursiveAlgorithm {
    ...
    public static void main(String[] args) {
        BiddingSupplierInfo sup1 = new BiddingSupplierInfo().setSupplierId("91").setSupplierName("1供应商").setPrice(BigDecimal.valueOf(10)).setSectionId("标段一");
        BiddingSupplierInfo sup2 = new BiddingSupplierInfo().setSupplierId("92").setSupplierName("2供应商").setPrice(BigDecimal.valueOf(12)).setSectionId("标段一");
        BiddingSupplierInfo sup3 = new BiddingSupplierInfo().setSupplierId("93").setSupplierName("3供应商").setPrice(BigDecimal.valueOf(14)).setSectionId("标段一");
        BiddingSupplierInfo sup4 = new BiddingSupplierInfo().setSupplierId("94").setSupplierName("4供应商").setPrice(BigDecimal.valueOf(25)).setSectionId("标段一");
        BiddingSupplierInfo sup5 = new BiddingSupplierInfo().setSupplierId("95").setSupplierName("5供应商").setPrice(BigDecimal.valueOf(8)).setSectionId("标段一");
        BiddingSupplierInfo sup6 = new BiddingSupplierInfo().setSupplierId("96").setSupplierName("6供应商").setPrice(BigDecimal.valueOf(24)).setSectionId("标段一");
        BiddingSupplierInfo sup7 = new BiddingSupplierInfo().setSupplierId("97").setSupplierName("7供应商").setPrice(BigDecimal.valueOf(22)).setSectionId("标段一");
        BiddingSupplierInfo sup8 = new BiddingSupplierInfo().setSupplierId("98").setSupplierName("8供应商").setPrice(BigDecimal.valueOf(19)).setSectionId("标段一");
        BiddingSupplierInfo sup9 = new BiddingSupplierInfo().setSupplierId("99").setSupplierName("9供应商").setPrice(BigDecimal.valueOf(19)).setSectionId("标段一");
        BiddingSupplierInfo sup46 = new BiddingSupplierInfo().setSupplierId("100").setSupplierName("10供应商").setPrice(BigDecimal.valueOf(21.8)).setSectionId("标段一");
        BiddingSupplierInfo sup47 = new BiddingSupplierInfo().setSupplierId("101").setSupplierName("11供应商").setPrice(BigDecimal.valueOf(19.0)).setSectionId("标段一");

        BiddingSupplierInfo sup10 = new BiddingSupplierInfo().setSupplierId("84").setSupplierName("4供应商").setPrice(BigDecimal.valueOf(19.9)).setSectionId("标段二");
        BiddingSupplierInfo sup11 = new BiddingSupplierInfo().setSupplierId("88").setSupplierName("8供应商").setPrice(BigDecimal.valueOf(12.4)).setSectionId("标段二");
        BiddingSupplierInfo sup12 = new BiddingSupplierInfo().setSupplierId("89").setSupplierName("9供应商").setPrice(BigDecimal.valueOf(16.6)).setSectionId("标段二");
        BiddingSupplierInfo sup13 = new BiddingSupplierInfo().setSupplierId("80").setSupplierName("10供应商").setPrice(BigDecimal.valueOf(27)).setSectionId("标段二");
        BiddingSupplierInfo sup14 = new BiddingSupplierInfo().setSupplierId("81").setSupplierName("11供应商").setPrice(BigDecimal.valueOf(32.2)).setSectionId("标段二");
        BiddingSupplierInfo sup15 = new BiddingSupplierInfo().setSupplierId("83").setSupplierName("13供应商").setPrice(BigDecimal.valueOf(47)).setSectionId("标段二");
        BiddingSupplierInfo sup16 = new BiddingSupplierInfo().setSupplierId("82").setSupplierName("1供应商").setPrice(BigDecimal.valueOf(18)).setSectionId("标段二");
        BiddingSupplierInfo sup17 = new BiddingSupplierInfo().setSupplierId("87").setSupplierName("2供应商").setPrice(BigDecimal.valueOf(15.9)).setSectionId("标段二");
        BiddingSupplierInfo sup18 = new BiddingSupplierInfo().setSupplierId("85").setSupplierName("3供应商").setPrice(BigDecimal.valueOf(16)).setSectionId("标段二");
        BiddingSupplierInfo sup48 = new BiddingSupplierInfo().setSupplierId("74").setSupplierName("14供应商").setPrice(BigDecimal.valueOf(22.2)).setSectionId("标段二");
        BiddingSupplierInfo sup49 = new BiddingSupplierInfo().setSupplierId("75").setSupplierName("15供应商").setPrice(BigDecimal.valueOf(23.1)).setSectionId("标段二");

        BiddingSupplierInfo sup19 = new BiddingSupplierInfo().setSupplierId("71").setSupplierName("1供应商").setPrice(BigDecimal.valueOf(8)).setSectionId("标段三");
        BiddingSupplierInfo sup20 = new BiddingSupplierInfo().setSupplierId("72").setSupplierName("2供应商").setPrice(BigDecimal.valueOf(10)).setSectionId("标段三");
        BiddingSupplierInfo sup21 = new BiddingSupplierInfo().setSupplierId("73").setSupplierName("3供应商").setPrice(BigDecimal.valueOf(19)).setSectionId("标段三");
        BiddingSupplierInfo sup22 = new BiddingSupplierInfo().setSupplierId("74").setSupplierName("4供应商").setPrice(BigDecimal.valueOf(19)).setSectionId("标段三");
        BiddingSupplierInfo sup23 = new BiddingSupplierInfo().setSupplierId("75").setSupplierName("5供应商").setPrice(BigDecimal.valueOf(19)).setSectionId("标段三");
        ...
        BiddingSupplierInfo sup28 = new BiddingSupplierInfo().setSupplierId("61").setSupplierName("1供应商").setPrice(BigDecimal.valueOf(19)).setSectionId("标段四");
        BiddingSupplierInfo sup29 = new BiddingSupplierInfo().setSupplierId("62").setSupplierName("2供应商").setPrice(BigDecimal.valueOf(19)).setSectionId("标段四");
        BiddingSupplierInfo sup30 = new BiddingSupplierInfo().setSupplierId("63").setSupplierName("3供应商").setPrice(BigDecimal.valueOf(19)).setSectionId("标段四");
        BiddingSupplierInfo sup31 = new BiddingSupplierInfo().setSupplierId("64").setSupplierName("4供应商").setPrice(BigDecimal.valueOf(19)).setSectionId("标段四");
        BiddingSupplierInfo sup32 = new BiddingSupplierInfo().setSupplierId("65").setSupplierName("5供应商").setPrice(BigDecimal.valueOf(19)).setSectionId("标段四");
        BiddingSupplierInfo sup33 = new BiddingSupplierInfo().setSupplierId("66").setSupplierName("6供应商").setPrice(BigDecimal.valueOf(19)).setSectionId("标段四");
        BiddingSupplierInfo sup34 = new BiddingSupplierInfo().setSupplierId("67").setSupplierName("7供应商").setPrice(BigDecimal.valueOf(19)).setSectionId("标段四");
        BiddingSupplierInfo sup35 = new BiddingSupplierInfo().setSupplierId("68").setSupplierName("8供应商").setPrice(BigDecimal.valueOf(19)).setSectionId("标段四");
        BiddingSupplierInfo sup36 = new BiddingSupplierInfo().setSupplierId("69").setSupplierName("9供应商").setPrice(BigDecimal.valueOf(19)).setSectionId("标段四");
        BiddingSupplierInfo sup52 = new BiddingSupplierInfo().setSupplierId("70").setSupplierName("19供应商").setPrice(BigDecimal.valueOf(19)).setSectionId("标段四");
        BiddingSupplierInfo sup53 = new BiddingSupplierInfo().setSupplierId("71").setSupplierName("20供应商").setPrice(BigDecimal.valueOf(33)).setSectionId("标段四");
